...
const Skills = () => {
  return (
    ...
    <div className="_skill-icons flex text-5xl justify-between">
        ...
        <FaReact className="text-[hsl(193,95%,68%)]"/>
        <RiTailwindCssFill className="text-[hsl(198,93%,60%)]"/>
        <FaWordpress className="text-[hsl(199,65%,37%)]"/>
        <FaGitAlt className="text-[hsl(9,86%,57%)]"/>
        <IoLogoFirebase className="text-[hsl(45,100%,58%)]"/>
